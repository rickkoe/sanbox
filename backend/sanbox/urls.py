"""
URL configuration for sanbox project.
...
urlpatterns = [
    ...
    path("api/auth/", include("authentication.urls")),  # API for authentication
    path("api/core/", include("core.urls")),  # API for core stuff
