    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified_by', models.ForeignKey(blank=True, help_text='User who last modified this storage system', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modified_storage_systems', to=settings.AUTH_USER_MODEL)),
            ],
            options={
