...
from .project_views import (
    ...
    project_add_pool, project_remove_pool,
...
urlpatterns = [
    ...
    path("projects/<int:project_id>/add-pool/", project_add_pool, name="project-add-pool"),
    path("projects/<int:project_id>/remove-pool/<int:pool_id>/", project_remove_pool, name="project-remove-pool"),
