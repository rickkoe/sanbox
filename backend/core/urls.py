...
from .project_views import (
    ...
    project_add_fabric, project_remove_fabric,
    project_add_storage, project_remove_storage,
    project_add_volume, project_remove_volume,
    project_add_host, project_remove_host,
    project_add_port, project_remove_port,
