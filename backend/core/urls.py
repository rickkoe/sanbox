...
from .views import ConfigViewSet, config_detail, projects_for_customer, ActiveConfigView, config_for_customer, create_project_for_customer, UpdateConfigView
...
urlpatterns = [
    ...
    path("config/update/<int:customer_id>/", UpdateConfigView.as_view(), name="update-config"),
