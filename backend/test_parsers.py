...
def test_cisco_parser():
    ...
    # Read example file
    base_dir = '/app' if os.path.exists('/app/claude_import_examples') else os.path.dirname(os.path.dirname(__file__))
    cisco_file = os.path.join(base_dir, 'claude_import_examples/cisco/show-running-config.txt')
...
def test_brocade_parser():
    ...
    # Test files
    base_dir = '/app' if os.path.exists('/app/claude_import_examples') else os.path.dirname(os.path.dirname(__file__))
    alias_file = os.path.join(base_dir, 'claude_import_examples/brocade/Rick_Koetter_251017_2325_ESILABS_AliasInfo.csv')
    zone_file = os.path.join(base_dir, 'claude_import_examples/brocade/Rick_Koetter_251017_2325_ESILABS_ZoneInfo.csv')
    fabric_file = os.path.join(base_dir, 'claude_import_examples/brocade/Rick_Koetter_251017_2325_ESILABS_FabricSummary.csv')
