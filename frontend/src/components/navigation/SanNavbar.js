      ...
      <div className="container d-flex justify-content-between">
        <ul className="navbar-nav">
          <li className="nav-item">
            <NavLink className="nav-link" to="/san/fabrics">
              Fabrics
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link" to="/san/aliases">
              Aliases
            </NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link" to="/san/zones">
              Zones
            </NavLink>
          </li>
        </ul>
        ...
        <div className="san-toggle-container">
          <span
            className={`san-toggle-label ${sanVendor === "BR" ? "active" : ""}`}
          >
            Brocade
          </span>
          <div
            className={`san-toggle-switch ${
              sanVendor === "CI" ? "switch-right" : "switch-left"
            }`}
          ...
          <span
            className={`san-toggle-label ${sanVendor === "CI" ? "active" : ""}`}
          >
            Cisco
          </span>
        </div>
