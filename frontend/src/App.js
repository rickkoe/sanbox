...
const CustomerTable = React.lazy(() => import("./components/tables/CustomerTableFast"));
const ProjectTable = React.lazy(() => import("./components/tables/ProjectTable"));
const FabricTable = React.lazy(() => import("./components/tables/FabricTableFast"));
const AliasTable = React.lazy(() => import("./components/tables/AliasTableFast"));
const ZoneTable = React.lazy(() => import("./components/tables/ZoneTableFast"));
const StorageTable = React.lazy(() => import("./components/tables/StorageTableFast"));
...
const HostTable = React.lazy(() => import("./components/tables/HostTableFast"));
